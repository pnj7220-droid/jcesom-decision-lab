...
# =============================================================================
# LOGO LOADER  — embeds marshall_logo.png as a base64 data URI if present
# =============================================================================
def _load_logo_data_uri():
    p = Path(__file__).parent / "marshall_logo.png"
    if p.exists():
...
# =============================================================================
    ...
    options_list = list(step["options"].items())  # [(tag, label), ...]
    option_labels = [f"{tag} — {label}" for tag, label in options_list]
    option_tags = [tag for tag, _ in options_list]
